...
> ★镜头1：vision_analyze 纠正——透视汇聚线+浅景深确认缓推，非固定。无日期条。
> 镜头2 日期条：「10.22 WED – 26 SUN」。
...
> ★镜头5背景：vision_analyze 纠正——飞碟形建筑（梅赛德斯-奔驰文化中心风格），非上海大剧院。
...
> ★镜头6：vision_analyze 确认跟拍（背景 motion blur）。
> ★镜头8：vision_analyze 纠正——独立粉锤（Tamper）形透明建筑，非陆家嘴环形天桥。东方明珠在背景远处。
> ★镜头9：vision_analyze 确认——咖啡机手柄（Portafilter），非摩卡壶。手柄=透明玻璃通道供小人穿行。
> ★镜头10背景：vision_analyze 纠正——白色现代主义立方建筑+外滩建筑群，非上海博物馆。
...
> 镜头12 内含飞艇「10th Anniversary」——飞艇不是独立镜头，是同一庆典场景的元素。
