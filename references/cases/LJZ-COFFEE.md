...
|---|--------|------|------|------|------|----------|------|------|----------|------|--------|
| 1 | 00:00–01.5 | 1.5s | 全景 | ★缓推 | 纵深对称（两岸向消失点汇聚） | 粉色江水#F4C2C2 / 建筑暖灰#C4956A / 晨光漫射5000K | — | 轮船汽笛 | 世界观引入 | 江面波纹 | ![镜头1](assets/LJZ-COFFEE/frame_01_ship.jpg) |
| 2 | 01.5–05.5 | 4.0s | 全景 | 固定 | 雕塑居中 / 前景圆桌 | 樱花粉#FFB7C5 / 草绿#90C695 / 日光5600K | 微缩小人（草坪圆桌喝咖啡） | 鸟鸣（微缩化·高通~200Hz） | 空间建立+标题曝光 | 白鸽飞行动画 | ![镜头2](assets/LJZ-COFFEE/frame_02_park.jpg) |
...
| # | 时间码 | 时长 | 景别 | 运镜 | 构图 | 色调+场景 | 角色 | 音效 | 叙事功能 | 特效 | 分镜图 |
|---|--------|------|------|------|------|----------|------|------|----------|------|--------|
| 3 | 05.5–07.5 | 2.0s | 中景 | 固定 | 球体居中 / 欧式广场（外滩风格建筑群） | 奶油白#F5E6D3 / 建筑暖灰 / 侧光45° | — | 牛奶注入咕噜声 | 首次咖啡元素注入城市 | 牛奶液体合成（实拍+跟踪） | ![镜头3](assets/LJZ-COFFEE/frame_03_milk.jpg) |
| 4 | 07.5–08.5 | 1.0s | 中景 | 固定 | 摩卡壶居中 / Haussmann 欧式街道 | 摩卡银#C0C0C0 / 建筑米白 / 左上方日光 | 微缩小人（排队点咖啡） | 摩卡壶蒸汽嘶嘶声 | 咖啡器具=城市建筑 | — | ![镜头4](assets/LJZ-COFFEE/frame_04_moka.jpg) |
| 5 | 08.5–11.0 | 2.5s | 中景 | 固定 | 冰淇淋居中 / ★飞碟形现代建筑背景 | 深巧克力#5C3317 / 奶白#F5F5F0 / 顶光 | 微缩小人（广场活动） | — | 食物欲望递进 | 巧克力酱液体合成 | ![镜头5](assets/LJZ-COFFEE/frame_05_chocolate.jpg) |
...
| # | 时间码 | 时长 | 景别 | 运镜 | 构图 | 色调+场景 | 角色 | 音效 | 叙事功能 | 特效 | 分镜图 |
|---|--------|------|------|------|------|----------|------|------|----------|------|--------|
| 6 | 11.0–14.0 | 3.0s | 中景 | ★跟拍 | 巴士居中（跟拍锁定） / 欧式街道+樱花树 | 巴士红#E31E24 / 建筑粉白 / 日光侧光 | 微缩乘客（车内喝咖啡） | 巴士引擎声 | 微缩世界「活化」——运动主体注入生命感 | — | ![镜头6](assets/LJZ-COFFEE/frame_06_bus.jpg) |
| 7 | 14.0–17.0 | 3.0s | 中景 | 固定 | 中国馆居中 / 广场 | 中国红#C41E3A / 咖啡豆深棕#3E1F0D / 日光侧光45° | — | 咖啡豆滚落碰撞 | 地标功能置换（储存→倾倒） | 咖啡豆刚体粒子模拟（~200-500粒） | ![镜头7](assets/LJZ-COFFEE/frame_07_beans.jpg) |
| 8 | 17.0–19.5 | 2.5s | 全景 | 固定 | ★粉锤装置居中 / 东方明珠背景 | 金属银#C8CCD0 / 咖啡粉棕#6F4E37 / 顶光 | 微缩小人（圆形建筑内喝咖啡） | 压粉器机械砰声 | 器具=建筑（粉锤→透明咖啡厅） | — | ![镜头8](assets/LJZ-COFFEE/frame_08_tamper.jpg) |
| 9 | 19.5–21.0 | 1.5s | 中景 | 固定 | 城堡居中 / 树木环绕 | 童话粉#F4C2C2 / 森林绿#7B9E6D / 日光漫射 | 微缩小人（穿行手柄透明通道） | 咖啡机蒸汽喷射 | 地标功能置换（城堡→萃取） | 蒸汽烟雾合成（扩散速度1/3-1/5） | ![镜头9](assets/LJZ-COFFEE/frame_09_disney.jpg) |
| 10 | 21.0–24.0 | 3.0s | 中景 | 固定 | 喷泉居中 / ★白色现代建筑+外滩建筑群背景 | 浓缩咖啡#6F4E37 / 奶泡白#FEFDFA / 日光 | 微缩小人（广场围观喷泉） | — | 咖啡制作最终形态——拉花艺术 | 牛奶拉花动态液体合成 | ![镜头10](assets/LJZ-COFFEE/frame_10_latteart.jpg) |
...
| # | 时间码 | 时长 | 景别 | 运镜 | 构图 | 色调+场景 | 角色 | 音效 | 叙事功能 | 特效 | 分镜图 |
|---|--------|------|------|------|------|----------|------|------|----------|------|--------|
| 11 | 24.0–27.5 | 3.5s | 全景 | 固定 | 宽幅天际线 / 两岸对称 | 日落金#E8A84C / 暖橙粉#D4785C / 金色逆光3200K | — | — | 情感收束——全片暖色最高潮 | 江面波光渲染 | ![镜头11](assets/LJZ-COFFEE/frame_11_sunset.jpg) |
| 12 | 27.5–33.0 | 5.5s | 全景→中景 | 固定 | 蛋糕居中 / 多层庆典元素 | 庆典红#E31E24 / 金色烟花#FFD700 / 暖光漫射 | 微缩乐队+庆祝人群（欢呼/举杯） | 烟花爆炸（低频boom+高频crackle）+人群欢呼 | 叙事高潮——十年情感释放 | 烟花粒子+彩带飘落+飞艇路径动画 | ![镜头12](assets/LJZ-COFFEE/frame_12_cake.jpg) |
...
| # | 时间码 | 时长 | 景别 | 运镜 | 构图 | 色调+场景 | 角色 | 音效 | 叙事功能 | 特效 | 分镜图 |
|---|--------|------|------|------|------|----------|------|------|----------|------|--------|
| 13 | 33.0–35.0 | 2.0s | — | — | 两人物居中 / 白底 | 纯白#FFFFFF / 红色点缀 / 平面光 | 两个卡通人物（庆祝姿态） | — | 情绪过渡——庆典→品牌 | 手绘插画转场 | ![镜头13](assets/LJZ-COFFEE/frame_13_airship.jpg) |
| 14 | 35.0–37.5 | 2.5s | — | 固定 | Logo 居中 / 白底 | 纯白#FFFFFF / 品牌红#E31E24 / 平面光 | — | — | 品牌确认——信息清零+强烙印 | — | ![镜头14](assets/LJZ-COFFEE/frame_14_logo_v2.jpg) |
...
| 角色 | 激活阶段 | 读拉片层 | 分镜图用途 |
|------|:---:|------|------|
| Writer | P2/P4 | §叙事节奏（时长分布/功能标记/节奏曲线） + §角色设计序列 | frame_01→02（叙事转折）、frame_12（群体行为高潮） |
| DP | P4 | §镜头语言序列（景别/运镜/构图/焦距/灯光） + §角色设计序列 | frame_01（纵深对称）、frame_06（跟拍 motion blur）、frame_11（宽幅全景） |
| Art Director | P3 | §色调+场景搭建序列（色调/光源/空间/道具/视觉重心/材质/色温） + §角色设计序列 | frame_02（樱花粉#FFB7C5）、frame_04（摩卡银材质）、frame_07（中国红#C41E3A+咖啡棕）、frame_11（日落金#E8A84C逆光） |
| Sound Designer | P5 | §音效序列（触发点/类型/层次）+ §角色设计序列 | 间接——时长分布推节奏密度 + 角色出场推声音时机 |
| VFX | P6 | §特效序列（类型/时机/关键技术/密度曲线） | frame_07（咖啡豆刚体粒子）、frame_12（烟花多层粒子+彩带+飞艇路径） |
